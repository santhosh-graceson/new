...
st.markdown("""
    <style> 
    div.css-ocqkz7.e1tzin5v3:nth-child(1),div.css-ocqkz7.e1tzin5v3:nth-child(2),div.css-ocqkz7.e1tzin5v3:nth-child(3),div.css-1r2k5ly.e1tzin5v0,div.css-peenxw.e1tzin5v0{
       column-gap: 0.1rem;
    }
    </style>
...
st.markdown("""
    <style>
   h2#ppeak,h2#flow,h2#volume,h2#rr,h2#i-e,h2#peep,h2#vti,h2#vte,p,h2#o2{
            ...
            if counter<9:
                ...
                for i in range(10):    
                    ...
                    if len(df_Inspiration_Flow) >= 300:
                        ...
                        df_Inspiration_Flow = df_Inspiration_Flow.iloc[135:]
